...
class TaskRanked(Base):
    ...
    has_active_sprint: Mapped[bool] = mapped_column(Boolean)
    ...
    is_unplatformed: Mapped[bool] = mapped_column(Boolean)
    has_estimate_no_team: Mapped[bool] = mapped_column(Boolean)
    has_unselected_estimate: Mapped[bool] = mapped_column(Boolean)
